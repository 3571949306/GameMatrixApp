...
public class RockModuleEntryPoint implements ModuleInterface, FeatureModule {
    ...
    public Fragment createFragment(Context context) {
        return new RockModuleFragment();
    }

    @Override
    public List<ModuleNavigationContribution> getNavigationContributions(Context context) {
        return Arrays.<ModuleNavigationContribution>asList(new RockNavContribution());
    }

    private static class RockNavContribution implements ModuleNavigationContribution {
        @Override
        public String getContributionId() { return "rock"; }

        @Override
        public String getTitle(Context context) { return "猜拳"; }
        ...
        @Override
        public Fragment createFragment(Context context) { return new RockModuleFragment(); }
