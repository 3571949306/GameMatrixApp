...
public class TetrisModuleEntryPoint implements ModuleInterface, FeatureModule {
    ...
    public Fragment createFragment(Context context) {
        return new TetrisModuleFragment();
    }

    @Override
    public List<ModuleNavigationContribution> getNavigationContributions(Context context) {
        return Arrays.<ModuleNavigationContribution>asList(new TetrisNavContribution());
    }

    private static class TetrisNavContribution implements ModuleNavigationContribution {
        @Override
        public String getContributionId() { return "tetris"; }

        @Override
        public String getTitle(Context context) { return "俄罗斯方块"; }
        ...
        @Override
        public Fragment createFragment(Context context) { return new TetrisModuleFragment(); }
