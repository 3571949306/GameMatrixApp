...
public class PipelineModuleEntryPoint implements ModuleInterface, FeatureModule {
    ...
    public Fragment createFragment(Context context) {
        return new PipelineModuleFragment();
    }

    @Override
    public List<ModuleNavigationContribution> getNavigationContributions(Context context) {
        return Arrays.<ModuleNavigationContribution>asList(new PipelineNavContribution());
    }

    private static class PipelineNavContribution implements ModuleNavigationContribution {
        @Override
        public String getContributionId() { return "pipeline"; }

        @Override
        public String getTitle(Context context) { return "管道工"; }
        ...
        @Override
        public Fragment createFragment(Context context) { return new PipelineModuleFragment(); }
