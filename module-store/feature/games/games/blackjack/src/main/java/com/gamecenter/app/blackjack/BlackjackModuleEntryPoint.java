...
public class BlackjackModuleEntryPoint implements ModuleInterface, FeatureModule {
    ...
    public Fragment createFragment(Context context) {
        return new BlackjackModuleFragment();
    }

    @Override
    public List<ModuleNavigationContribution> getNavigationContributions(Context context) {
        return Arrays.<ModuleNavigationContribution>asList(new BlackjackNavContribution());
    }

    private static class BlackjackNavContribution implements ModuleNavigationContribution {
        @Override
        public String getContributionId() { return "blackjack"; }

        @Override
        public String getTitle(Context context) { return "21点"; }
        ...
        @Override
        public Fragment createFragment(Context context) { return new BlackjackModuleFragment(); }
