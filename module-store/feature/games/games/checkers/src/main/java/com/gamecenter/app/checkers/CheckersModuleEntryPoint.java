...
public class CheckersModuleEntryPoint implements ModuleInterface, FeatureModule {
    ...
    public Fragment createFragment(Context context) {
        return new CheckersModuleFragment();
    }

    @Override
    public List<ModuleNavigationContribution> getNavigationContributions(Context context) {
        return Arrays.<ModuleNavigationContribution>asList(new CheckersNavContribution());
    }

    private static class CheckersNavContribution implements ModuleNavigationContribution {
        @Override
        public String getContributionId() { return "checkers"; }

        @Override
        public String getTitle(Context context) { return "跳棋"; }
        ...
        @Override
        public Fragment createFragment(Context context) { return new CheckersModuleFragment(); }
