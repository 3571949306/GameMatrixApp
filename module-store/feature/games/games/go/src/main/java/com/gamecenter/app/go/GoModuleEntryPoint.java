...
public class GoModuleEntryPoint implements ModuleInterface, FeatureModule {
    ...
    public Fragment createFragment(Context context) {
        return new GoModuleFragment();
    }

    @Override
    public List<ModuleNavigationContribution> getNavigationContributions(Context context) {
        return Arrays.<ModuleNavigationContribution>asList(new GoNavContribution());
    }

    private static class GoNavContribution implements ModuleNavigationContribution {
        @Override
        public String getContributionId() { return "go"; }

        @Override
        public String getTitle(Context context) { return "围棋"; }
        ...
        @Override
        public Fragment createFragment(Context context) { return new GoModuleFragment(); }
