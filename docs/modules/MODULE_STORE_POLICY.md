...
- 模块市场默认打开“游戏”分类�?- 顶部分类不再提供“全部”选项，只保留游戏、浏览器、工具箱、AI 助手、VPN�?- 游戏分类内也不显示“全部”子分类；默认展示全部游戏，可再切换益智、休闲、经典�?- 模块市场右上角保留两个显式操作：刷新当前列表、进入已下载模块列表；最右侧为已下载列表按钮�?- 已下载模块列表按全部、游戏、浏览器、工具箱、AI 助手、VPN 分类过滤�?- 模块卡片的下�?打开按钮下方显示“卸载”快捷按钮，仅对已下载模块显示�?
## 游戏大厅边界
