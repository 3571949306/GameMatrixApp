...
1. **APK 签名异常** - 安装包提�?开发者签名有异常"
2. **自动更新源选择错误** - 显示"已是最新版�?，实际有新版�?
3. **构建配置问题** - release 版本未正确签�?
...
1. �?**APK 签名配置** - 使用正确的路径引用，启用 V1 �?V2 签名
2. �?**更新源选择逻辑** - 修复版本比较，正确检测新版本
3. �?**构建系统配置** - 修复上传脚本�?Gradle 任务
