...
- 远端仓库只维�?`main` 分支�?
- 本机 GitHub 上传已改�?GitHub-only Git 代理：`http://127.0.0.1:10808`�?
- 重新检测或修复本地代理配置请运�?`工具/network/Configure-GitHubProxy.ps1 -Apply`�?
...
```json
{
  ...
  "publicBaseUrl": "https://update.your-server.example.com",
  "postUploadCommands": [
