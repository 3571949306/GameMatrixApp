...
**内部版本号**: 224  
**APK 大小**: ~16.5 MB  
**签名状态**: ✅ 已签名（GameMatrix.keystore, SHA384withRSA）  
**发布时间**: 2026-05-12  
**状态**: ✅ 已成功发布到所有更新源
...
| **GitHub Releases** | https://github.com/3571949306/GameMatrixApp/releases | ⏳ 待上传 | 224 (1.3.18) | 16.44 MB |
