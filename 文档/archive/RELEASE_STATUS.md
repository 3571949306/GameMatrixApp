...
- 发布提醒：正式 APK 发布仍走本机签名和既有 服务器部署/GitHub Release 脚本；云端 CI 负责验证，不保存 release 签名材料。
...
| 更新源 | URL | 状态 | 版本 |
|--------|-----|------|------|
| **香港 VPS** | https://hk-update.tcp0053.shop | ✅ 已验证 | 265 (1.3.27) |
| **美国 VPS** | https://tcp0053.shop:1443 | ✅ 已验证 | 265 (1.3.27) |
| **GitHub Releases** | https://github.com/3571949306/GameMatrixApp/releases/tag/1.3.27 | ✅ 已上传 | 265 (1.3.27) |
