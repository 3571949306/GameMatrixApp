...
class ReactionTest : EmulatorTestBase() {

    companion object {
        private const val TAG = "ReactionTest"
    }

    private val activityClass = "com.gamecenter.app.games.reaction.ReactionActivity"
