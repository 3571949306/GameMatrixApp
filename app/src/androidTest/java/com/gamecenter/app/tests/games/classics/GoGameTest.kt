...
class GoGameTest : EmulatorTestBase() {

    companion object {
        private const val TAG = "GoGameTest"
    }

    private val activityClass = "com.gamecenter.app.games.go.GoActivity"

    /**
     * TC-GO-001: 验证围棋能正常启动，不崩溃。
     */
    @Test
    ...
    fun test_003_gameInteraction() {
        ...
        safeSleep(2000)
        // 点击"开始对弈"按钮
        GameTestHelper.clickButtonByText(device, "开始对弈", 2000)
        safeSleep(1000)
        // 点击棋盘中心模拟落子
        ...
        safeSleep(1000)
        // 尝试点击虚着按钮
        GameTestHelper.clickButtonByText(device, "虚着", 2000)
        safeSleep(1000)
        GameTestHelper.assertAppAlive(device)
    }

    /**
     * TC-GO-004: 验证退出围棋返回大厅。
     */
    @Test
