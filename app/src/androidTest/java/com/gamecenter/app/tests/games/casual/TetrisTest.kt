...
class TetrisTest : EmulatorTestBase() {

    companion object {
        private const val TAG = "TetrisTest"
    }

    private val activityClass = "com.gamecenter.app.games.tetris.TetrisActivity"
