 ...
 * <p>关键设计决策：
 * <ul>
 *   <li>通过 {@link NetworkDelegate} 委托接口与 Activity 交互，避免直接持有 Activity 引用</li>
 *   <li>客户端意图采用"发送+两次重试"策略（220ms 和 700ms 后各重发一次），提高弱网环境下的可靠性</li>
 *   <li>断线时将意图缓存到 pendingClientIntent，重连后自动补发</li>
