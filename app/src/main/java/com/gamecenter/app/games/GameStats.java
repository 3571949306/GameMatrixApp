 ...
 * 游戏统计数据模型
 * <p>
 * 记录单个游戏的完整统计信息，包括最高分、胜负场次、游戏次数、
 * 最佳用时、总游玩时间和最后游玩时间。
 * 该类作为数据传输对象（DTO），由GameUsageStore负责持久化和读取。
 * </p>
 * <p>
 * 关键设计决策：
 * <ul>
 *   <li>字段使用public修饰，简化数据访问，因为该类仅作为纯数据容器</li>
 *   <li>提供无参构造函数以支持Gson反序列化</li>
 *   <li>胜率计算仅基于胜/负场次，不包含平局</li>
 * </ul>
 * </p>
 */
public class GameStats {
    /** 游戏唯一标识符，与GameRegistry中的Entry.id对应 */
